...
function [map] = registerCellsGUI(folderpath,subfigfold,imaging_technique,microns_per_pixel,alignment_type,maximal_distance,maximal_rotation,transformation_smoothness)
