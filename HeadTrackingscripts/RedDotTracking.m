...
redThresh = 0.05;          % Must be a value between 1 and 0. The lower the number the more sensitve it is
...
% % %             hold on            
            ...
            if frame ~=0 && ~isempty(targetR)                 %skip frame unless green and red can be found
...
% % %             plot(REDco(:,1),REDco(:,2),'r')    %Live plot
% % %             hold off
            frame = frame + 1;
