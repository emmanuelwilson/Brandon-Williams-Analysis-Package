...
redThresh = 0.001;          % Must be a value between 1 and 0. The lower the number the more sensitve it is
...
LEDxDist = 25;              %Max distance between LED's in the x axis in pixels
LEDyDist = 25;              %Max distance between LED's in the y axis in pixels
