...
[Calcium, TrialInds,rawSep,rawCalcium] = TouchRaster_V5_invisible(events,ms,fps,1,1,1,1,1,1);
...
%Delay
DisplayComp_V2_invisible(SepDelay,minmax,'Delay',ShuffledCrit.DcorrectCells);
%Front Anchored
DisplayComp_V2_invisible(SepFront,minmax,'FrontAnchored',ShuffledCrit.FcorrectCells);
%Back Anchored
DisplayComp_V2_invisible(SepBack,minmax,'BackAnchored',ShuffledCrit.BcorrectCells);
%}
clf
%Figure4: Locating the source of the error signal
%Delay
confInterD = ErrorSource_V2_invisible(SepDelay,1,pwd,ShuffledCrit.DcorrectCells);
%Front Anchored
confInterF = ErrorSource_V2_invisible(SepFront,2,pwd,ShuffledCrit.FcorrectCells);
%Back Anchored
confInterB = ErrorSource_V2_invisible(SepBack,3,pwd,ShuffledCrit.BcorrectCells);
