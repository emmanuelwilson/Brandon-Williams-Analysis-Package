...
function [out,ccell,icell,cccell,iccell] = ChoiceSep_TEST(events, cchoice, ichoice, cind,iind,ccind,icind,ct,it,cct,ict,cl,il,ccl,icl,minmax,cut,dirName,save)
