function [out, detailed]= msEgoCentricRateMapSplitEvenOddParallel_V3_BinFigureGen(ms,HD,tracking, frameMap, dimX, dimY, deconvolve, QP,cellIndex,DistBinSize,DegBinSize,allocentric)
