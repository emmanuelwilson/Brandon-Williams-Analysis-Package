function [out, detailed]= msEgoCentricRateMapSplitEvenOddParallelSHUFFLE_V2(ms,HD,tracking, frameMap, dimX, dimY, deconvolve, QP)
...
name = 'EBCevenOddSplitParallelDeconvolved_CircSHUFFLE.mat';
...
savefig('Shuffled_MRL_Hist_Circ_Corr.fig')
end
