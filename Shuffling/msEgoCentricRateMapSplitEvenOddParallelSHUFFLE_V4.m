function [out, detailed]= msEgoCentricRateMapSplitEvenOddParallelSHUFFLE_V4(ms,HD,tracking, frameMap, dimX, dimY, deconvolve, QP, DistBinSize,DegBinSize)
...
parfor itteration = 1 : 100
    ...
    for cellNum = 1 : length(firing(1,:))           
        ...
        if(~isempty(ifire) && ~isempty(ifire1) && ~isempty(ifire2))
            ...
            occ3d = zeros(360/DegBinSize,FOVsize/DistBinSize+1);
            occ13d = zeros(360/DegBinSize,FOVsize/DistBinSize+1);
            occ23d = zeros(360/DegBinSize,FOVsize/DistBinSize+1);
            
            nspk3d = zeros(360/DegBinSize,FOVsize/DistBinSize+1);
            nspk13d = zeros(360/DegBinSize,FOVsize/DistBinSize+1);
            nspk23d = zeros(360/DegBinSize,FOVsize/DistBinSize+1);
...
out.dimX = dimX;
out.dimY = dimY;
out.DistBinSize = DistBinSize;
out.DedBinSize = DegBinSize;
out.QP = QP;
