function [out, detailed]= msEgoCentricRateMapSplitEvenOddParallelSHUFFLE_V4_unevenBins(ms,HD,tracking, frameMap, dimX, dimY, deconvolve, QP, DistBinSize,DegBinSize)
