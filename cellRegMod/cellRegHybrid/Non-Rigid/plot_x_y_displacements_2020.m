function [x_y_displacements]=plot_x_y_displacements_2020(neighbors_x_displacements,neighbors_y_displacements,microns_per_pixel,maximal_distance,number_of_bins,centers_of_bins,figures_directory,figures_visibility)
