function ms = msNormCorre(ms,isnonrigid,doWindowed,varargin);
...
%         disp('Rigid motion correction...');
        options = NoRMCorreSetParms('d1',d1-bound,'d2',d2-bound,'bin_width',200,'max_shift',30,'iter',1,'correct_bidir',false);
    end
