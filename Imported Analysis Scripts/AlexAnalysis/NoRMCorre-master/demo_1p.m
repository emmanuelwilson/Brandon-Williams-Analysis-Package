...
folder = 'D:/Dropbox (Epstein Lab)/ThreeRooms_TwoDoors_OneExperiment/Data/RawCalcium_1LED/ANP021117/18-04-19_Baseline/msCam*.avi';
...
for iter = 1
    for i = 1:length(name)
        ...
        options_r.mem_filename = [folder(1:end-10) name(i).name(1:end-4) '_garbage.mat'];
