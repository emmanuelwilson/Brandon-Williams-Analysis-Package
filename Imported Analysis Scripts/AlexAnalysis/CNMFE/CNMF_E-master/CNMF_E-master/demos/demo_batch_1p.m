...
neuron = Sources2D(); 
% nams = {'./data_1p.tif'};
% nams = {get_fullname('./Data/RawCalcium_1LED/ANP021117/18-04-23_Baseline/compiled.tif')};% you can put all file names into a cell array; when it's empty, manually select files 
% nams = neuron.select_data([]);
% nams = [];
