...
sufficient_correlation=0.0; % smaller correlation imply different optical section or high noise levels
...
typical_cell_size= 3+randi(12); % in micrometers - determines the radius that is used for gaussfit 20
