...
neuron = Sources2D(); 
nams = [{get_fullname('./Data/RawCalcium_1LED/ANP030803/18-04-19_Baseline/msCam1.tif')}];          % you can put all file names into a cell array; when it's empty, manually select files 
