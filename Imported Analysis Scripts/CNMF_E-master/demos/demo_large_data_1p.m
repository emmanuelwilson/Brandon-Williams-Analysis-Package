...
%% choose data
neuron = Sources2D();
nam = get_fullname('./v20180226_027.mat');          % this demo data is very small, here we just use it as an example
...
deconv_options = struct('type', 'ar1', ... % model of the calcium traces. {'ar1', 'ar2'}
    'method', 'threshold', ... % method for running deconvolution {'foopsi', 'constrained', 'thresholded'}
